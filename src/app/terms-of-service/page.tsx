            ...
            <CardContent className="p-8">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="body-large text-foreground mb-6">
                  These terms of service govern your use of the RichBlend Consult website and services.
                </p>
                ...
                <p className="body-regular text-foreground mb-4">
                  RichBlend Consult shall not be liable for any indirect, incidental, or consequential damages arising

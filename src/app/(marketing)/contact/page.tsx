...
import { Mail, Phone, MapPin, Clock, Star, Award, Users, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="absolute bottom-40 right-20 w-40 h-40 bg-secondary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-accent/5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '4s' }}></div>
        ...
        <section className="relative py-20 lg:py-32">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto mb-16">
              ...
              <h1 className="heading-hero text-primary mb-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                Let's Start Your Child's
                <br />
                <span className="text-secondary">Learning Journey</span>
              </h1>

              <p className="body-large text-muted-foreground max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                Ready to unlock your child's potential? Get in touch with Temitope Adeniyi, 
                your trusted 11+ and SEN specialist with over 20 years of experience.
              </p>
            </div>
              ...
              <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                ...
                <Card className="glass-card border-0 shadow-xl hover-lift">
                  <CardContent className="p-6">
                    <h3 className="heading-card text-primary mb-6">Contact Information</h3>
                ...
                <Card className="glass-card border-0 shadow-xl hover-lift">
                  <CardContent className="p-6">
                    <h3 className="heading-card text-primary mb-6">Why Choose Us</h3>
                ...
                <Card className="glass-card border-0 shadow-xl hover-lift bg-gradient-to-br from-primary/5 to-secondary/5">
                  <CardContent className="p-6 text-center">
                    ...
                    <h4 className="heading-card text-primary mb-2">Quick Response</h4>
        ...
        <div className="absolute top-1/4 -left-4 hidden xl:block">
          <Card className="glass-card border-0 shadow-xl p-4 rotate-3 hover-lift float-animation shimmer-light dark:shimmer-dark">
            <div className="text-center">
              <div className="text-lg font-bold text-secondary mb-1">11+ Expert</div>
              <div className="text-xs text-muted-foreground">Specialist Tutor</div>
            </div>
          </Card>
        </div>
        ...
        <div className="absolute bottom-1/4 -right-4 hidden xl:block">
          <Card className="glass-card border-0 shadow-xl p-4 -rotate-2 hover-lift float-animation-delayed shimmer-light dark:shimmer-dark">
            <div className="text-center">
              <div className="text-lg font-bold text-primary mb-1">SEN Support</div>
              <div className="text-xs text-muted-foreground">Inclusive Learning</div>
            </div>
          </Card>
        </div>
      </main>

  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div
            ...
            className="flex items-center justify-center space-x-1 mb-6 opacity-0 translate-y-5"
          >
          ...
          <h1
            ref={headlineRef}
            className="heading-hero text-primary mb-6 opacity-0 translate-y-5 transition-colors duration-300 hover:text-primary/80"
          >
          ...
          <p
            ref={subheadlineRef}
            className="body-large text-foreground/80 mb-8 max-w-2xl mx-auto opacity-0 translate-y-5 transition-colors duration-300 hover:text-foreground"
          >
          ...
          <div
            ref={ctaRef}
            className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 opacity-0 translate-y-5"
          >
            <Button
              size="lg"
          ...
          <div
            ...
            className="mt-12 flex flex-wrap items-center justify-center space-x-8 text-sm text-foreground/70 opacity-0 translate-y-5"
          >
      ...
      <div
        ...
        className="absolute top-1/4 left-8 bg-card/80 backdrop-blur-sm border border-border p-4 rounded-xl transform hidden lg:block opacity-0 translate-y-8 rotate-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-2"
      >
      ...
      <div
        ...
        className="absolute bottom-1/4 right-8 bg-card/80 backdrop-blur-sm border border-border p-4 rounded-xl transform hidden lg:block opacity-0 translate-y-8 -rotate-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-2"
      >
